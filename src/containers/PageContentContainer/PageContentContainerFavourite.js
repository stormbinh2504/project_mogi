...
import "./PageContentContainerFavourite.scss"
...
import PageListNewsFavourite from './PageListNewsFavourite/PageListNewsFavourite';
const PageContentContainerFavourite = () => {
    ...
    console.log("binh_PageContentContainerFavourite", { listCates })
            ...
            <div className="container">
                <div className="breadcrumb-content">
                    <PageBreadcrumb
                        ...
                        prevPageTitle2={{
                            "name": "Danh sách nhà đất yêu thích",
                            "pathName": "/thue-nha-dat-quan-tam"
                        }}
                    />
                </div>
                <div className="row">
...
export default PageContentContainerFavourite